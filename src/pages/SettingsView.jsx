...
export default function SettingsView() {
  ...
  return (
    <div className="bg-white overflow-hidden mt-[75px] mx-auto px-6">
      <ul role="list" className="divide-y divide-gray-200">
        {settings.map((settings) => (
          <li key={settings.name} className="flex items-center justify-between">
            {settings.link ? (
              <Link
                to={settings.link}
                className="block hover:bg-gray-50 flex items-center justify-between w-full"
              >
              ...
              <div className="block hover:bg-gray-50 flex items-center justify-between w-full">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
