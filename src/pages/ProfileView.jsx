  ...
  return (
    <div className="relative mt-[75px]">
      ...
      <div className="mx-auto my-4 px-6">
        ...
        <div className="mt-4 bg-white overflow-hidden h-[125px] rounded-[25px] backdrop-blur-2xl border-4 border-light-gray"
            ...
            <div className="px-3 py-3 text-gray-900 flex flex-col justify-between h-full">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <p className="text-sm font-bold text-red-500 ml-1">Health</p>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
              ...
              <div className="px-3 py-3 text-gray-900 flex flex-col justify-between h-full">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-sm font-bold text-pink-500 ml-1">
                      Calendar
                    </p>
                  </div>
                  <svg
